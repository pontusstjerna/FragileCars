...
public class DirectionalRect {
    ...
    public Side intersect(int x, int y, int threshold) {
        ...
        for (Side side : Side.values()) {// Loop through all the sides
            ...
            if ((fstX == cutX && sndX == cutX && y > Math.min(getSide(side, true).getY(), getSide(side, false).getY())
    ...
    public String toString() {
        return "DirectionalRect with direction " + dir + " and corners: " + "FRONT_LEFT: " + "(" + corners[0].getX()
                + "," + corners[0].getY() + ") FRONT_RIGHT: " + "(" + corners[1].getX() + "," + corners[1].getY()
                + ") BACK_LEFT: " + "(" + corners[2].getX() + "," + corners[2].getY() + ") BACK_RIGHT: " + "("
